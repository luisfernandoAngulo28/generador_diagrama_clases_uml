...
> *Guarda tu captura en `screenshots/01_interfaz_principal.png`*

![Interfaz Principal](screenshots/01_interfaz_principal.png)
...
> *Guarda tu captura en `screenshots/02_edicion_clase.png`*

![Edición de Clase](screenshots/02_edicion_clase.png)
...
> *Guarda tu captura en `screenshots/03_relaciones_multiplicidades.png`*

![Relaciones UML](screenshots/03_relaciones_multiplicidades.png)
...
> *Guarda tu captura en `screenshots/04_colaboracion_tiempo_real.png`*

![Colaboración en Tiempo Real](screenshots/04_colaboracion_tiempo_real.png)
...
> *Guarda tu captura en `screenshots/05_asistente_ia.png`*

![Asistente IA](screenshots/05_asistente_ia.png)
...
> *Guarda tu captura en `screenshots/06_enterprise_architect_xmi.png`*

![Enterprise Architect XMI](screenshots/06_enterprise_architect_xmi.png)
...
> *Guarda tu captura en `screenshots/07_codigo_generado_swagger.png`*

![Swagger y Código Generado](screenshots/07_codigo_generado_swagger.png)
...
> *Guarda tu captura en `screenshots/08_app_movil_flutter.png`*

![App Móvil Flutter](screenshots/08_app_movil_flutter.png)
